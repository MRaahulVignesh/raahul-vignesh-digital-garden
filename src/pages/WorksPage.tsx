          ...
          <Container>
            ...
            <div className="space-y-6">
              {projects.map((project, index) => (
                <div 
                  key={index} 
                  className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 p-6 relative overflow-hidden group"
                >
                  <div className="absolute top-0 left-0 h-full w-1 bg-accent-light group-hover:bg-accent transition-colors duration-300"></div>
                  
                  <h3 className="text-xl font-semibold mb-4 text-accent-dark">{project.title}</h3>
                  
                  <ul className="list-disc pl-5 mb-5 text-gray-700 space-y-2 marker:text-accent-light">
                    ...
                    <div className="flex gap-3 pt-2 border-t border-gray-100">
                      {project.githubUrl && (
                        <a 
                          ...
                          className="text-sm text-highlight hover:text-highlight-dark transition-colors mt-2"
                          target="_blank"
